        ...
        <section className=' py-5 xl:pb-14 xl:pt-6 bg-black -mt-1'>
            <div className="container px-3 2xl:px-0 mt-1.5 xl:mb-14">
                ...
                <div className=" pt-2 gap-6 flex flex-row flex-wrap justify-center lg:flex-nowrap">
                    {blue_box.map((item) => (
                        <div key={item.id} className="lg:w-3/12 sm:w-5/12 w-10/12 group min-h-[214px]" data-aos="zoom-in" data-aos-duration="1500">
                            <div className=" h-full bg-[linear-gradient(116.46deg,_rgba(255,_255,_255,_0.2)_2.09%,_rgba(255,_255,_255,_0.1)_96.43%)] group-hover:bg-[linear-gradient(149.67deg,_#815CC8_29.44%,_#1BABFE_81.54%)] duration-300 ease-linear p-px rounded-[13px] min-h-[181px] group-hover:shadow-[0px_8px_30px_0px_#1BABFE]">
                                <div className="bg-black  h-full rounded-[13px] group-hover:bg-transparent">
                                    <a href={item.link} target='_blank' className="px-2 h-full bg-[linear-gradient(110.75deg,_rgba(255,_255,_255,_0.1)_0.01%,_rgba(255,_255,_255,_0.03)_99.99%)] min-h-[179px] rounded-[13px] flex justify-center h-full flex-col items-center duration-300 ease-linear group-hover:bg-[linear-gradient(149.67deg,_#815CC8_29.44%,_#1BABFE_81.54%)]">
