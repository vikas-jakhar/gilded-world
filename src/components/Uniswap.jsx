...
import { Horse } from '../icon';

const Uniswap = () => {
    return (
        <section className=' bg-Uniswap bg-no-repeat bg-cover bg-center min-h-[885px] -mt-2 flex items-center'>
