...
import billion from "../assets/image/svg/billion.svg";
import hand from "../assets/image/svg/hand-coin.svg";
import holder from "../assets/image/svg/holders.svg";
import nft from "../assets/image/svg/nft.svg";
        ...
        <section className='bg-token bg-no-repeat bg-center bg-cover py-5 xl:py-24 -mt-2'>
            <div className="container px-3 xl:mt-8 mb-10 pt-2.5 2xl:px-0">
                ...
                <div className="flex flex-row flex-wrap justify-center lg:flex-nowrap gap-6 pt-3">
                    {blue_box.map((item) => (
                        <div key={item.id} className="lg:w-3/12 sm:w-5/12 w-10/12 group" data-aos="zoom-in" data-aos-duration="1500">
