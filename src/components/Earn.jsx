        ...
        <section className=' relative bg-black py-5 -mt-2'>
            <div className="container px-3 relative z-[1] lg:mt-8 lg:pt-12 pb-12 mb-14 2xl:px-0">
                <div className="flex flex-col items-center pb-1.5">
                    <h2 className=' font-Josefin font-bold text-3xl sm:text-5xl text-white'>
                        Play To <span className=' bg-[linear-gradient(90deg,_#815CC8_0%,_#1BABFE_100%)] bg-clip-text text-transparent'>Earn</span>
                    </h2>
                    <p className=' mt-5 font-poppins font-normal text-base sm:text-xl sm:leading-[33px] text-white opacity-70 text-center max-w-[1024px]'>
